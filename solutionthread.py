...
class Solution2:
    def __init__(self):
        ...
        pygame.display.set_caption('Threadli Sudoku Çözümü')
        self.running = True
        self.grid = board
        self.selected = None
        self.mousePos = None
    ...
    def drawNumbers(self, window):
        ...
        for a in range(9):
            ...
            for b in range(9):
                pos = [20 + i, 40+k]
                self.textToScreen(window, str(samuraithread.topleft[j]), pos)
                i = i + 30
                j = j + 1
        ...
        for a in range(9):
            ...
            for b in range(9):
                pos = [380 + i, 40 + k]
                self.textToScreen(window, str(samuraithread.topright[j]), pos)
                i = i + 30
                j = j + 1
        ...
        for a in range(9):
            ...
            for b in range(9):
                pos = [20 + i, 400 + k]
                self.textToScreen(window, str(samuraithread.bottomleft[j]), pos)
                i = i + 30
                j = j + 1
        ...
        for a in range(9):
            ...
            for b in range(9):
                pos = [380 + i, 400 + k]
                self.textToScreen(window, str(samuraithread.bottomright[j]), pos)
                i = i + 30
                j = j + 1
        ...
        for a in range(3):
            ...
            for b in range(3):
                pos = [290 + i, 220 + k]
                self.textToScreen(window, str(samuraithread.middle[j]), pos)
                i = i + 30
                j = j + 1
