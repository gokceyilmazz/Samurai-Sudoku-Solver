...
class Solution:
    def __init__(self):
        ...
        pygame.display.set_caption('Sudoku Çözümü')
        self.running = True
        self.grid = board
        self.selected = None
        self.mousePos = None
    ...
    def drawNumbers(self, window):
        ...
        for a in range(9):
            ...
            for b in range(9):
                pos = [20 + i, 40+k]
                self.textToScreen(window, str(topleft[j]), pos)
                i = i + 30
                j = j + 1
        ...
        for a in range(9):
            ...
            for b in range(9):
                pos = [380 + i, 40 + k]
                self.textToScreen(window, str(topright[j]), pos)
                i = i + 30
                j = j + 1
        ...
        for a in range(9):
            ...
            for b in range(9):
                pos = [20 + i, 400 + k]
                self.textToScreen(window, str(bottomleft[j]), pos)
                i = i + 30
                j = j + 1
        ...
        for a in range(9):
            ...
            for b in range(9):
                pos = [380 + i, 400 + k]
                self.textToScreen(window, str(bottomright[j]), pos)
                i = i + 30
                j = j + 1
        ...
        for a in range(3):
            ...
            for b in range(3):
                pos = [290 + i, 220 + k]
                self.textToScreen(window, str(middle[j]), pos)
                i = i + 30
                j = j + 1
